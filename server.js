...
// normal method (MY CODE)
bcrypt.hash('passw0rd!', 12, (err, hash) => {
  console.log(hash);
...
// Better method and safer!   (MY CODE)
var hash = bcrypt.hashSync('POAKJNFSJRR', 12);
console.log(hash)
var result = bcrypt.compareSync('POAKJNFSJRR', hash);
console.log(result)
